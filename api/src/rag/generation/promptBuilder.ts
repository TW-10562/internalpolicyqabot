...
export const buildEnterpriseRagSystemPrompt = (
  ...
  const lines = [
    ...
    '',
    '',
    'FORMATTING RULES (MANDATORY — you MUST follow these):',
    '- NEVER output a wall of text or long paragraphs. ALWAYS break your answer into bullet points.',
    '- Each separate fact, condition, or rule MUST be its own bullet point using "- " prefix.',
    '- Use **bold** for key terms, policy names, numbers, durations, and important values.',
    '- When the answer involves comparisons, schedules, thresholds, or multi-column data, use a markdown table:',
    '  | Header1 | Header2 |',
    '  |---------|---------|',
    '  | value1  | value2  |',
    '- Start with one brief summary sentence, then list all details as bullet points.',
    '- For procedures or steps, use numbered list (1. 2. 3.).',
    '- Keep each bullet to one fact only. Do NOT combine multiple facts in a single bullet.',
    '- Example format:',
    '  Summary sentence here.',
    '  - **Key term**: Detail about this point',
    '  - **Another term**: Another detail',
    '  - Condition or eligibility requirement',
  ];

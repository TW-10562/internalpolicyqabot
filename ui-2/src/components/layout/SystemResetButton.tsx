...
export default function SystemResetButton() {
  ...
  const handleReset = async () => {
    ...
    try {
      const res = await executeSystemReset(confirmationText.trim());
      if (res.code !== 200) {
      ...
      toast.success(
        ...
        t('systemReset.toast.successSsoBody', undefined, 'System has been reset. Please log in again via Microsoft SSO.'),
      );

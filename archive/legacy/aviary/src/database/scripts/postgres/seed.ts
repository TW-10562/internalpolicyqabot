...
async function main() {
  ...
  try {
    ...
    console.log("📋 Phase 2: Seeding departments...");
    await seedDepartments();

    console.log("📋 Phase 3: Seeding users...");
    await seedUsers();

    console.log("📋 Phase 4: Seeding user-role mappings...");
    await seedUserRoles();

    console.log("📋 Phase 5: Seeding menus...");
    await seedMenus();

    console.log("📋 Phase 6: Seeding dictionary types...");
    await seedDictTypes();

    console.log("📋 Phase 7: Seeding dictionary data...");
    await seedDictData();

    console.log("📋 Phase 8: Seeding configuration...");
    await seedConfig();
